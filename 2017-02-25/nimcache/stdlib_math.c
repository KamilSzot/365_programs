...
{	result0 = (NI)0;
	...
	nimln(27, "math.nim");
	{
		...
		nimln(27, "math.nim");
		TMP150 = mulInt(((NI) 2), k0);
		if (!(n0 < (NI)(TMP150))) goto LA7;
		TMP151 = subInt(n0, k0);
		result0 = binom_99202_1009420244(n0, (NI)(TMP151));
		goto BeforeRet;
	}
	LA7: ;
	nimln(28, "math.nim");
	result0 = n0;
	{
		...
		res_99222_1009420244 = ((NI) 2);
		{
			...
			while (1) {
				...
				nimln(30, "math.nim");
				TMP152 = addInt(n0, ((NI) 1));
				TMP153 = subInt((NI)(TMP152), i_99218_1009420244);
				TMP154 = mulInt(result0, (NI)(TMP153));
				TMP155 = divInt((NI)(TMP154), i_99218_1009420244);
				result0 = (NI)(TMP155);
				nimln(1891, "system.nim");
				TMP156 = addInt(res_99222_1009420244, ((NI) 1));
				res_99222_1009420244 = (NI)(TMP156);
			} LA11: ;
		}
	}
	}BeforeRet: ;
	...
	result0 = ((NI) 1);
	{
		...
		res_99245_1009420244 = ((NI) 2);
		{
			...
			while (1) {
				...
				nimln(36, "math.nim");
				TMP157 = mulInt(result0, i_99241_1009420244);
				result0 = (NI)(TMP157);
				nimln(1891, "system.nim");
				TMP158 = addInt(res_99245_1009420244, ((NI) 1));
				res_99245_1009420244 = (NI)(TMP158);
			} LA3: ;
		}
	}
	popFrame();
